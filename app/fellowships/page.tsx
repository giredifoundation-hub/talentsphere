...
export default function FellowshipsPage() {
  const [fellowships, setFellowships] = useState<Opportunity[]>([]);
  ...
  const filteredFellowships = fellowships.filter((fellowship) => {
    ...
    return (
      fellowship.title.toLowerCase().includes(term) ||
      fellowship.organization.toLowerCase().includes(term) ||
      fellowship.location.toLowerCase().includes(term)
    );
  });
      ...
      <section className="bg-blue-700 px-6 py-14 text-white">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-4 max-w-2xl text-lg text-blue-100">
            Discover fellowship opportunities for professional,
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Browse available fellowship opportunities.
            </p>
          </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {filteredFellowships.map((fellowship) => (
                ...
                >
                  ...
                  <div className="mt-6">
                    <a
                      href={`/opportunity/${fellowship.id}`}
